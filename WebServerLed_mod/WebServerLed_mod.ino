...
// Value of touchpad threshold
// above which is considered ON
...
// Choose a different port from port 80 
// outside the reserved zone
...
void setup()
{
  ...
  digitalWrite(led1, HIGH); // led1 is one while connecting to WiFi
  ...
  digitalWrite(led1, LOW); // led1 turn off as connected to WiFi
  
  // start the web server on port 3566
  server.begin();
}
...
void loop()
{
  ...
  // turn on/off led1 with touchpad
...
//          client.print("<html>\r\n");
//          client.print("<body>\r\n");
//          client.print(<img src="\image.png" alt="Image from ESP8266" width="200" height="200">);
//
//          client.print("</body>\r\n");
//          client.print("</html>\r\n");
